class Payment
  ...
  def save
    ...
    # item = Item.create(name: name, text: text, category_id: category_id, price: price, condition_id: condition_id, postage_id: postage_id, exhibitor_prefecture_id: exhibitor_prefecture_id,days_id: days_id, user_id: user.id)
